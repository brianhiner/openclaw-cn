...
If you can run `npm install -g clawdbot-cn@latest` but later see `clawdbot-cn: command not found`, it’s almost always a **PATH** issue: the directory where npm puts global binaries isn’t on your shell’s PATH.
